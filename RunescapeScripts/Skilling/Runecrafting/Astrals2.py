...
def craft_astrals():
    try:
        ...
        Common.watch_click_image(bank1_images, 0.7, 'Click bank booth', False,
                                 1, 10, None, Common.Main_game_screen_region)
        ...
        for x in range(loops_till_done):
            ...
            Common.watch_click_image(bank1_images, 0.7, 'Click bank booth 1', False, 2,
                                     10, None, Common.Main_game_screen_region)
